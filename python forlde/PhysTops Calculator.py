...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.solveButton1dm = QtWidgets.QPushButton(self.centralwidget)
        self.solveButton1dm.setGeometry(QtCore.QRect(245, 370, 250, 100))
        self.solveButton1dm.setObjectName("solveButton1dk")
        self.solveButton1dm.setStyleSheet("background-color: rgb(213, 126, 0);")
        self.solveButton1dm.clicked.connect(self.Main5)
        
        self.solveButton2dm = QtWidgets.QPushButton(self.centralwidget)
        self.solveButton2dm.setGeometry(QtCore.QRect(505, 370, 250, 100))
        ...
        self.exitButton.setGeometry(QtCore.QRect(400, 550, 200, 90))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_main.setText(_translate("MainWindow", "PhysTops for Phonies"))
...
"Kinematics"))
        ...
        self.solveButton1dm.setStatusTip(_translate("MainWindow", "One Dimensional\n Momentum"))
        self.solveButton1dm.setText(_translate("MainWindow", "One Dimensional\n Momentum"))
        self.solveButton1dm.setShortcut(_translate("MainWindow", "3"))
        ...
        self.menuProgram.setTitle(_translate("MainMenu", "Program"))
        self.actionAbout.setText(_translate("MainMenu", "About"))
        self.actionAbout.setShortcut(_translate("MainMenu", "Ctrl+Z"))
        self.actionNew.setText(_translate("MainMenu", "New"))
